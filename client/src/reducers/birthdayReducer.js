...
export const GET_TODAY_BIRTHDAYS_LOADING = 'GET_TODAY_BIRTHDAYS_LOADING';
export const GET_TODAY_BIRTHDAYS_SUCCESS = 'GET_TODAY_BIRTHDAYS_SUCCESS';
...
const birthdayReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case GET_TODAY_BIRTHDAYS_SUCCESS:
			return {
				...state,
				todayBirthdays: action.payload,
			};
		case GET_TODAY_BIRTHDAYS_FAIL:
			return {
				...state,
				todayBirthdays: [],
			};
